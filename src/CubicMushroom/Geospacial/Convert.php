...
class Convert
{
     ...
     *
     * @param mixed $bf0  Ellipsoid semi major axis multiplied by central meridian
     *                    scale factor (bf0) in meters; 
     * @param mixed $n    (computed from a, b and f0);
     * @param mixed $PHI0 lat of false origin (PHI0) 
     * @param mixed $PHI  initial or final latitude of point (PHI) IN RADIANS.
     *
     * @return float
     */
    public static function Marc($bf0, $n, $PHI0, $PHI) {
     ...
     * http://bramp.net/blog/2008/06/os-easting-northing-to-lat-long/
     *
     * @param mixed $North Northing of point (North) and northing of false origin
     *                     
     * @param mixed $n0    (n0) in meters
     * @param mixed $afo   Semi major axis multiplied by central meridian scale
     *                     factor (af0) in meters
     * @param mixed $PHI0  Latitude of false origin (PHI0) IN RADIANS
     * @param mixed $n     n (computed from a, b and f0)
     * @param mixed $bfo   ellipsoid semi major axis multiplied by central meridian
     *                     scale factor (bf0) in meters.
     *
     * @return float
     */
    public static function initialLat($North, $n0, $afo, $PHI0, $n, $bfo) {
